...
if(hkvs_cam_CONFIG_INCLUDED)
  return()
endif()
set(hkvs_cam_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(hkvs_cam_SOURCE_PREFIX /home/tyj/liantiaonew/src/hkvs_cam)
  set(hkvs_cam_DEVEL_PREFIX /home/tyj/liantiaonew/devel)
  set(hkvs_cam_INSTALL_PREFIX "")
  set(hkvs_cam_PREFIX ${hkvs_cam_DEVEL_PREFIX})
else()
  set(hkvs_cam_SOURCE_PREFIX "")
  set(hkvs_cam_DEVEL_PREFIX "")
  set(hkvs_cam_INSTALL_PREFIX /home/tyj/liantiaonew/install)
  set(hkvs_cam_PREFIX ${hkvs_cam_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'hkvs_cam' is deprecated")
...
set(hkvs_cam_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/tyj/liantiaonew/src/hkvs_cam/include;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv " STREQUAL " ")
  set(hkvs_cam_INCLUDE_DIRS "")
  set(_include_dirs "/home/tyj/liantiaonew/src/hkvs_cam/include;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv")
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    list(APPEND hkvs_cam_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(hkvs_cam_LIBRARY_DIRS ${lib_path})
      list(APPEND hkvs_cam_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'hkvs_cam'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND hkvs_cam_LIBRARIES ${lib})
    endif()
  endif()
...
set(hkvs_cam_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${hkvs_cam_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "cv_bridge")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 hkvs_cam_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${hkvs_cam_dep}_FOUND)
      find_package(${hkvs_cam_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${hkvs_cam_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(hkvs_cam_INCLUDE_DIRS ${${hkvs_cam_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(hkvs_cam_LIBRARIES ${hkvs_cam_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${hkvs_cam_dep}_LIBRARIES})
  _list_append_deduplicate(hkvs_cam_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(hkvs_cam_LIBRARIES ${hkvs_cam_LIBRARIES})

  _list_append_unique(hkvs_cam_LIBRARY_DIRS ${${hkvs_cam_dep}_LIBRARY_DIRS})
  list(APPEND hkvs_cam_EXPORTED_TARGETS ${${hkvs_cam_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${hkvs_cam_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
